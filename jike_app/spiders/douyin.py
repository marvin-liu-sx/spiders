...
class DouyinSpider(scrapy.Spider):
    ...
    url = 'https://aweme.snssdk.com/aweme/v1/feed/?iid=31717878106&ac=WIFI&os_api=18&app_name=aweme&channel=App%20Store&idfa=80DEEA4B-2DC9-43FE-A097-4619DFBF8468&device_platform=iphone&build_number=17909&vid=787FF51A-8429-4C9D-93C1-27A6CD0AE7D8&openudid=93d55ca4a7fd3596e0ee7434610d3c1aac90c8f7&device_type=iPhone7,1&app_version=1.7.9&device_id=10258085598&version_code=1.7.9&os_version=9.3.2&screen_width=1125&aid=1128&count=6&feed_style=0&max_cursor=0&pull_type=2&type=0&volume=0.00&mas=0098aea8eacc0e2e63965ee05cf7e0b7dd9675ce7752c8782126a8&as=a145836e40163a89ec5217&ts=1525430624'
    def start_requests(self):
        for i in range(100000):
            yield Request(url=self.url, method='GET', headers=self.default_headers, callback=self.parse, dont_filter=True)
