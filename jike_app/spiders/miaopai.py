...
with xlrd.open_workbook(r'C:\Users\zc-yy\Desktop\1.xlsx') as book:
    ...
    for row in range(1, row_count):
        ...
        if 'https://www.miaopai.com/' in trdata[0]:
...
class MiaopaiSpider(scrapy.Spider):
    ...
    def parse(self, response):
        if response:
            ...
            media_name = response.xpath("//div[@class='personalAbout']/div[@class='personalData']/p[@class='personalDataN']/a/text()").extract_first()
